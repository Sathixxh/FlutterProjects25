...
// // //     'This is a Flutter Local Notification', // Body
// // //     notificationDetails,
// // //   );
// // // }
...
// //     0,
// //     'Scheduled Notification',
// //     'This notification will appear after 5 seconds',
// //     tz.TZDateTime.now(tz.local).add(const Duration(seconds: 5)), // Schedule after 5 seconds
// //     notificationDetails,
...
//         channelDescription: 'Notification for scheduling',
...
//  void scheduleMondayNotification() async {
//   await AwesomeNotifications().createNotification(
//     content: NotificationContent(
//       id: 1,
//       channelKey: 'scheduled_channel', // Same as defined in initialize
//       title: 'Weekly Monday Notification',
//       body: 'This notification will appear every Monday at 3:30 PM!',
//       notificationLayout: NotificationLayout.Default,
//     ),
//     schedule: NotificationCalendar(
//       weekday: DateTime.monday, // Monday
//       hour: 16, // 3 PM in 24-hour format
//       minute: 03,
//       second: 0,
//       allowWhileIdle: true, // Works even if the app is closed
//       repeats: true, // To repeat every week
//     ),
//   );
// }
...
//       body: Center(
//         child: ElevatedButton(
//           onPressed: scheduleMondayNotification,
//           child: const Text('Schedule Notification'),
//         ),
//       ),
//     );
...
class _NotificationPageState extends State<NotificationPage> {
  ...
  void showChatNotification(String message) async {
    await AwesomeNotifications().createNotification(
      content: NotificationContent(
        id: DateTime.now().millisecondsSinceEpoch ~/ 1000, // Unique ID
        channelKey: 'chat_channel', // Same as defined in initialize
        title: 'New Message',
        body: message,
        notificationLayout: NotificationLayout.Default,
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Chat Notifications')),
      body: Center(
        child: ElevatedButton(
          onPressed: () {
            // Send a test message
